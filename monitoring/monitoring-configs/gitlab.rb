...
external_url 'http://51.250.2.221'
...
# ]
 prometheus['scrape_configs'] = [
   {
     'job_name': 'state-metrics-cluster',
     'static_configs' => [
       'targets' => ['k8s-master1:30080'],
     ],
   },
   {
     'job_name': 'prometheus-cluster',
     'static_configs' => [
       'targets' => ['k8s-master1:30090'],
     ],
   },
#   {
#     'job_name': 'blackbox',
...
#     ],
#     'static_configs' => [
#       'targets' => ['http://k8s-worker1:30001'],
#     ],
#     'relabel_configs' => [
#       [
...
################################################################################
 ...
 alertmanager['flags'] = {
   'web.listen-address' => "k8s-automate:9093",
...
grafana['metrics_enabled'] = false
grafana['metrics_basic_auth_username'] = 'admin' # default: nil
grafana['metrics_basic_auth_password'] = 'password' # default: nil
grafana['alerting_enabled'] = false
...
grafana['datasources'] = [
  ...
  {
    'name' => 'prometheus-from-cluster',
    'type' => 'prometheus',
    'access' => 'proxy',
    'url' => 'http://k8s-master1:30090'
  }
]
